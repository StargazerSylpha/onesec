<template>
    <div id="news-container">
        ...
        <div id="news-header" class="container-header">
            <span id="news-title" class="header-title">{{$store.state.pjtitle}}</span>
                ...
                <el-col class="news-left-navi">
                    <div id="news-left-navi">
                        ...
                        <div id="news-left-navi-tab">
                            <el-tabs tab-position="left" :value="activeTab" @tab-click="tabClick">
                                <el-tab-pane label="首页" name="home"></el-tab-pane>
                                <!--数字转换成字符串，防止vue warn报错-->
                                <el-tab-pane v-for="category in categoryList" :key="category.catid" :label="category.catname" :name="category.catid + ''"></el-tab-pane>
                            </el-tabs>
                        </div>
                    </div>
                </el-col>
    ...
    methods: {
        tabActiveChange() {
            if(this.$route.name === "newsCategory") {
                this.activeTab = this.$route.params.categoryId + "";
            } else {
        ...
        tabClick: function (_tabName) {
            if (_tabName.name === "home"  ) {
                ...
                if(this.$route.name === "newsCategory") {
                    this.$router.push("/news/category/" + _tabName.name);
