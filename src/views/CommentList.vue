<template>
    <div id="comment-list-container">
        ...
        <div class="info-change-content-top"><!--category-edit-content-->
            <div class="function-title">评论列表</div>

            <div id="comment-list-table" class="info-change-items-content-left">
                <div>
                    <el-row>
                        <el-col style="width: 900px;">
                            <el-pagination layout="prev,pager,next" @current-change="pageChange" :current-page="getCommentListForm.currentPage" :page-size="getCommentListForm.pageSize" :total="getCommentListForm.total" ></el-pagination>
                        </el-col>
                    ...
                    <div class="edit-form-item-row-space">
                        <el-table class="comment-list-table" :data="commentList" v-loading="getCommentListForm.tableLoading">
...
export default {
    ...
    mounted() {
        document.title = '评论列表' + ' - ' + store.state.pageTitle;
        this.getCommentList();
    },
    methods: {
        deleteComment(_cid) {
        ...
        pageChange(_newPage) {
            //后台页码从0开始...
            this.getCommentListForm.currentPage = _newPage;
            this.getCommentList(_newPage - 1);
        },
        ...
        getCommentList(_pageId) {
            this.getCommentListForm.tableLoading = true;
            ...
            axios.get(store.state.apiUrl + "/api/comment/getCommentList?t=" + Math.random(),{
                ...
                if(response.data.errcode === 0) {
                    ...
                    this.getCommentListForm.tableLoading = false;
                } else  {
                    this.$message({
                        type: "error",
                        message: "[" + response.data.errcode+ "]" + response.data.msg,
